...
const cars = [
  ...
  },
  {
    ...
    category: "Hatchback",
    description:
      "Volkswagen Golf GTI Mk8 cu motor TSI de 2.0L și 245 CP, cutie DSG cu 7 trepte. 0-100 km/h în 6.3 secunde, viteză maximă 250 km/h. Echipat cu diferențial electronic VAQ, suspensie sport, jante BBS de 18\", sistem IQ.DRIVE cu asistență la condus. Clasicul hot hatch reinventat.",
    images: [
