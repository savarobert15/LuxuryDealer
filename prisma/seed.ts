...
const cars = [
  ...
  },
  {
    ...
    category: "Supercar",
    description:
      "Ferrari FXX K — hypercar de circuit derivat din LaFerrari, cu sistem hibrid de 1050 CP (motor V12 de 6.3L + motor electric KERS). Produs în doar 32 de exemplare, exclusiv pentru clienți Ferrari select. 0-100 km/h în sub 2.5 secunde, aerodinamică activă, anvelopele Pirelli slick de curse.",
    images: [
  ...
  },
  {
    ...
    category: "Supercar",
    description:
      "Lexus LFA — capodopera ingineriei japoneze, produs în doar 500 de exemplare. Motor V10 de 4.8L aspirat natural cu 552 CP, care urla până la 9000 RPM, sunet validat de Yamaha. Caroserie integral din fibra de carbon, cutie de viteze secventiala cu 6 trepte, 0-100 km/h în 3.7 secunde. Un colecționar adevărat.",
    images: [
      "https://images.unsplash.com/photo-1621993202328-f5e1b4d3e3e3?w=1200&q=80",
      "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=1200&q=80",
      "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=1200&q=80",
    ],
    featured: true,
